<template>
  <div class="header">
    ...
    <div class="backGround">
      <img width="100%" height="100%" src="https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=2944606985,3722907313&fm=11&gp=0.jpg" alt="">
    </div>
  </div>
</template>
<script>
...
.header
  ...
  .backGround
    ...
    height: 100%;
    z-index -1
    filter blur(10px) // 虚化 值越大 虚化效果越好
</style>