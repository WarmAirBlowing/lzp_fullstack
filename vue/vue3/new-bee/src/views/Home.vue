<template>
  ...
  <!-- 商品列表 -->
  <goods-list :title="'新品上线'" :goods="newGoods"></goods-list>
  <goods-list :title="'热门商品'" :goods="hotGoods"></goods-list>
  <goods-list :style="{paddingBottom: '100px'}" :title="'最新推荐'" :goods="recommendGoods"></goods-list>
  <nav-bar></nav-bar>
</template>
...
export default {
  ...
  setup() {
    ...
    onMounted(async () => {
      ...
      state.recommendGoods = data.recommendGoodses
      Toast.clear()
    })
